...
def create_pages(window):
    ...
    page_0 = pages.create_page("page_0",   bg_color=(1, 1, 253, 1),  bg_image="assets/background/background.jpg")
    page_1 = pages.create_page("page_1",   bg_color=(1, 1, 253, 1),  bg_image="assets/background/background.jpg")
    page_2 = pages.create_page("page_2",   bg_color=(1, 1, 253, 1),  bg_image="assets/background/background.jpg")
